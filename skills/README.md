...
This directory contains standardized **Skills** that can be utilized by AI agents. A Skill is a self-contained package of instructions (`PROMPT.md`), documentation (`README.md`), and executable tools (`scripts/`).
...
└── <skill-name>/
    ...
    ├── PROMPT.md           # The system prompt / instructions for the Agent
...
To use a skill:
1.  Load the `PROMPT.md` into the agent's context.
